...
$get_teacher_data = getTableData('teachers', 'photo', $t_id);
?>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                            <?php if ($get_teacher_data['photo'] != "") : ?>
                                <div class="nav-profile-img">
                                    <img src="<?php echo $get_teacher_data['photo']  ?>" alt="image">
                            ...
                            <div class="nav-profile-text">
                                <p class="mb-1 text-black"><?php echo $_SESSION['teacher_login']['name'] ?></p>
                            </div>
                        </a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            ...
                            <div class="nav-profile-image">
                                <?php if ($get_teacher_data['photo'] != "") : ?>
                                    <img src="<?php echo $get_teacher_data['photo']  ?>" alt="profile">
                                <?php else : ?>
                            ...
                            <div class="nav-profile-text d-flex flex-column">
                                <span class="font-weight-bold mb-2"><?php echo $_SESSION['teacher_login']['name'] ?></span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#ui-basic70" aria-expanded="false" aria-controls="ui-basic">
                            <span class="menu-title">Attendance</span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi-crosshairs-gps menu-icon"></i>
                        </a>
                        <div class="collapse" id="ui-basic70">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="new-attendance.php">New Attendance</a></li>
